...
// AL = AX = EAX
#define decode_operand_eax \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_EAX;

#define decode_operand_ecx \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_ECX;

#define decode_operand_edx \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_EDX;

#define decode_operand_ebx \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_EBX;

#define decode_operand_esp \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_ESP;

#define decode_operand_ebp \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_EBP;

#define decode_operand_esi \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_ESI;

#define decode_operand_edi \
	opr_src.type = OPR_REG; \
	opr_src.addr = REG_EDI;
...
#define decode_operand_ecx2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_ECX; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_edx2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_EDX; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_ebx2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_EBX; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_esp2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_ESP; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_ebp2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_EBP; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_esi2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_ESI; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;

#define decode_operand_edi2eax \
	opr_src.type=OPR_REG; \
	opr_src.addr=REG_EDI; \
	opr_dest.type=OPR_REG; \
	opr_dest.addr=REG_EAX;
